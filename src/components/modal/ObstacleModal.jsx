...
import AddObstacleHook from '../../hook/add-obstacle-hook';
import { X, AlignLeft, Check } from "lucide-react";

const ObstacleModal = ({onClose, id}) => {
    const [note, handleNoteChange, handleAddObstacle] = AddObstacleHook(id);
    const handleSubmit = async (e) => {
        e.preventDefault();
       await handleAddObstacle();
        onClose();
      };
  return (
    <div
